...
const slots = [
  ...
  // MAY
  { start: "2025-05-01", end: "2025-05-03", nights: 3, price: 250, description: "Dal 1 al 3 maggio 250€ (3 notti)" },
  { start: "2025-05-04", end: "2025-05-10", nights: 7, price: 480, description: "Dal 4 al 10 maggio 480€ (7 notti)" },
  { start: "2025-05-04", end: "2025-05-07", nights: 4, price: 280, description: "Dal 4 al 7 maggio 280€ (4 notti)" },
  { start: "2025-05-08", end: "2025-05-10", nights: 3, price: 230, description: "Dal 8 al 10 maggio 230€ (3 notti)" },
  { start: "2025-05-11", end: "2025-05-17", nights: 7, price: 480, description: "Dal 11 al 17 maggio 480€ (7 notti)" },
  { start: "2025-05-11", end: "2025-05-14", nights: 4, price: 280, description: "Dal 11 al 14 maggio 280€ (4 notti)" },
  { start: "2025-05-15", end: "2025-05-17", nights: 3, price: 230, description: "Dal 15 al 17 maggio 230€ (3 notti)" },
  { start: "2025-05-18", end: "2025-05-24", nights: 7, price: 480, description: "Dal 18 al 24 maggio 480€ (7 notti)" },
  { start: "2025-05-18", end: "2025-05-21", nights: 4, price: 280, description: "Dal 18 al 21 maggio 280€ (4 notti)" },
  { start: "2025-05-22", end: "2025-05-24", nights: 3, price: 230, description: "Dal 22 al 24 maggio 230€ (3 notti)" },
  { start: "2025-05-25", end: "2025-05-31", nights: 7, price: 480, description: "Dal 25 al 31 maggio 480€ (7 notti)" },
  { start: "2025-05-25", end: "2025-05-28", nights: 4, price: 280, description: "Dal 25 al 28 maggio 280€ (4 notti)" },
  { start: "2025-05-29", end: "2025-06-01", nights: 3, price: 230, description: "Dal 29 maggio al 1 giugno 230€ (3 notti)" },
  

   // JUNE
   { start: "2025-06-01", end: "2025-06-07", nights: 7, price: 500, description: "Dal 1 al 7 giugno 500€ (7 notti)" },
   { start: "2025-06-01", end: "2025-06-04", nights: 4, price: 280, description: "Dal 1 al 4 giugno 280€ (4 notti)" },
   { start: "2025-06-05", end: "2025-06-07", nights: 3, price: 230, description: "Dal 5 al 7 giugno 230€ (3 notti)" },
   { start: "2025-06-08", end: "2025-06-14", nights: 7, price: 500, description: "Dal 8 al 14 giugno 500€ (7 notti)" },
   { start: "2025-06-08", end: "2025-06-11", nights: 4, price: 280, description: "Dal 8 al 11 giugno 280€ (4 notti)" },
   { start: "2025-06-12", end: "2025-06-14", nights: 3, price: 230, description: "Dal 12 al 14 giugno 230€ (3 notti)" },
   { start: "2025-06-15", end: "2025-06-21", nights: 7, price: 500, description: "Dal 15 al 21 giugno 500€ (7 notti)" },
   { start: "2025-06-15", end: "2025-06-18", nights: 4, price: 320, description: "Dal 15 al 18 giugno 320€ (4 notti)" },
   { start: "2025-06-19", end: "2025-06-21", nights: 3, price: 230, description: "Dal 19 al 21 giugno 230€ (3 notti)" },
   { start: "2025-06-22", end: "2025-06-28", nights: 7, price: 550, description: "Dal 22 al 28 giugno 550€ (7 notti)" },
   { start: "2025-06-22", end: "2025-06-25", nights: 4, price: 320, description: "Dal 22 al 25 giugno 320€ (4 notti)" },
   { start: "2025-06-26", end: "2025-06-28", nights: 3, price: 230, description: "Dal 26 al 28 giugno 230€ (3 notti)" },
   { start: "2025-06-29", end: "2025-07-05", nights: 7, price: 570, description: "Dal 29 giugno al 5 luglio 570€ (7 notti)" },
   { start: "2025-06-29", end: "2025-07-02", nights: 4, price: 320, description: "Dal 29 giugno al 2 luglio 320€ (4 notti)" },
   { start: "2025-07-03", end: "2025-07-05", nights: 3, price: 280, description: "Dal 3 al 5 luglio 280€ (3 notti)" },
   
  // JULY
  { start: "2025-07-06", end: "2025-07-12", nights: 7, price: 600, description: "Dal 6 al 12 luglio 600€ (7 notti)" },
  { start: "2025-07-06", end: "2025-07-09", nights: 4, price: 360, description: "Dal 6 al 9 luglio 360€ (4 notti)" },
  { start: "2025-07-10", end: "2025-07-12", nights: 3, price: 280, description: "Dal 10 al 12 luglio 280€ (3 notti)" },
  { start: "2025-07-13", end: "2025-07-19", nights: 7, price: 660, description: "Dal 13 al 19 luglio 660€ (7 notti)" },
  { start: "2025-07-13", end: "2025-07-16", nights: 4, price: 380, description: "Dal 13 al 16 luglio 380€ (4 notti)" },
  { start: "2025-07-17", end: "2025-07-19", nights: 3, price: 315, description: "Dal 17 al 19 luglio 315€ (3 notti)" },
  { start: "2025-07-20", end: "2025-07-26", nights: 7, price: 690, description: "Dal 20 al 26 luglio 690€ (7 notti)" },
  { start: "2025-07-20", end: "2025-07-23", nights: 4, price: 400, description: "Dal 20 al 23 luglio 400€ (4 notti)" },
  { start: "2025-07-24", end: "2025-07-26", nights: 3, price: 330, description: "Dal 24 al 26 luglio 330€ (3 notti)" },
  { start: "2025-07-27", end: "2025-07-30", nights: 4, price: 400, description: "Dal 27 al 30 luglio 400€ (4 notti)" },
  { start: "2025-07-27", end: "2025-08-02", nights: 7, price: 690, description: "Dal 27 luglio al 2 agosto 690€ (7 notti)" },
  { start: "2025-07-31", end: "2025-08-02", nights: 3, price: 330, description: "Dal 31 luglio al 2 agosto 330€ (3 notti)" },
  

  // AUGUST
  { start: "2025-08-03", end: "2025-08-09", nights: 7, price: 725, description: "Dal 3 al 9 agosto 725€ (7 notti)" },
{ start: "2025-08-03", end: "2025-08-06", nights: 4, price: 420, description: "Dal 3 al 6 agosto 420€ (4 notti)" },
{ start: "2025-08-07", end: "2025-08-09", nights: 3, price: 345, description: "Dal 7 al 9 agosto 345€ (3 notti)" },
{ start: "2025-08-10", end: "2025-08-16", nights: 7, price: 960, description: "Dal 10 al 16 agosto 960€ (7 notti)" },
{ start: "2025-08-10", end: "2025-08-12", nights: 3, price: 330, description: "Dal 10 al 12 agosto 330€ (3 notti)" },
{ start: "2025-08-13", end: "2025-08-16", nights: 4, price: 680, description: "Dal 13 al 16 agosto 680€ (4 notti)" },
{ start: "2025-08-17", end: "2025-08-23", nights: 7, price: 900, description: "Dal 17 al 23 agosto 900€ (7 notti)" },
{ start: "2025-08-17", end: "2025-08-20", nights: 4, price: 520, description: "Dal 17 al 20 agosto 520€ (4 notti)" },
{ start: "2025-08-21", end: "2025-08-23", nights: 3, price: 435, description: "Dal 21 al 23 agosto 435€ (3 notti)" },
{ start: "2025-08-24", end: "2025-08-30", nights: 7, price: 780, description: "Dal 24 al 30 agosto 780€ (7 notti)" },
{ start: "2025-08-24", end: "2025-08-27", nights: 4, price: 460, description: "Dal 24 al 27 agosto 460€ (4 notti)" },
{ start: "2025-08-28", end: "2025-08-30", nights: 3, price: 360, description: "Dal 28 al 30 agosto 360€ (3 notti)" },

  // SEPTEMBER
  { start: "2025-08-31", end: "2025-09-06", nights: 7, price: 690, description: "Dal 31 agosto al 6 settembre 690€ (7 notti)" },
  { start: "2025-08-31", end: "2025-09-03", nights: 4, price: 400, description: "Dal 31 agosto al 3 settembre 400€ (4 notti)" },
  { start: "2025-09-04", end: "2025-09-06", nights: 3, price: 330, description: "Dal 4 al 6 settembre 330€ (3 notti)" },
  { start: "2025-09-07", end: "2025-09-13", nights: 7, price: 630, description: "Dal 7 al 13 settembre 630€ (7 notti)" },
  { start: "2025-09-07", end: "2025-09-10", nights: 4, price: 360, description: "Dal 7 al 10 settembre 360€ (4 notti)" },
  { start: "2025-09-11", end: "2025-09-13", nights: 3, price: 300, description: "Dal 11 al 13 settembre 300€ (3 notti)" },
  { start: "2025-09-14", end: "2025-09-20", nights: 7, price: 580, description: "Dal 14 al 20 settembre 580€ (7 notti)" },
  { start: "2025-09-14", end: "2025-09-17", nights: 4, price: 340, description: "Dal 14 al 17 settembre 340€ (4 notti)" },
  { start: "2025-09-18", end: "2025-09-20", nights: 3, price: 270, description: "Dal 18 al 20 settembre 270€ (3 notti)" },
  { start: "2025-09-21", end: "2025-09-27", nights: 7, price: 540, description: "Dal 21 al 27 settembre 540€ (7 notti)" },
  { start: "2025-09-21", end: "2025-09-24", nights: 4, price: 320, description: "Dal 21 al 24 settembre 320€ (4 notti)" },
  { start: "2025-09-25", end: "2025-09-27", nights: 3, price: 250, description: "Dal 25 al 27 settembre 250€ (3 notti)" },
  
  // OCTOBER
  { start: "2025-09-28", end: "2025-10-04", nights: 7, price: 520, description: "Dal 28 settembre al 4 ottobre 520€ (7 notti)" },
  { start: "2025-09-28", end: "2025-10-01", nights: 4, price: 320, description: "Dal 28 settembre al 1 ottobre 320€ (4 notti)" },
  { start: "2025-10-02", end: "2025-10-04", nights: 3, price: 235, description: "Dal 2 al 4 ottobre 235€ (3 notti)" }
